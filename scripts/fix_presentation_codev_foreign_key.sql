-- Script pour corriger la contrainte de clé étrangère presentation_codev_candidat_id_fkey
...
BEGIN
    -- Parcourir tous les schémas qui contiennent la table presentation_codev
    FOR schema_rec IN 
        SELECT table_schema as schema_name
        FROM information_schema.tables 
        WHERE table_name = 'presentation_codev' 
