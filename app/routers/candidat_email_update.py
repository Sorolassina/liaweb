...
from app_lia_web.app.models.base import User, Candidat, Preinscription, Inscription, Document, Entreprise
...
def get_email_history(
    ...
    from app_lia_web.app.models.base import ActivityLog
    logs = session.exec(
        select(ActivityLog)
