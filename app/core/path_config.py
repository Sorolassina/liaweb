...
class PathConfig:
    ...
    def __init__(self):
        ...
        self.UPLOAD_DIR = BASE_DIR / settings.UPLOAD_DIR  # Chemin complet vers uploads (pour fichiers PDF, Word, etc.)
        self.MEDIA_DIR = BASE_DIR / settings.MEDIA_ROOT  # Chemin complet vers media (pour images, vidéos, MP3, etc.)
